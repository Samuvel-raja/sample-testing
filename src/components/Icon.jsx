// Inline SVG icons (feather-style). No icon library — keeps bundle small and CSP simple.
const ICONS = {
  logo: (
    <>
  ...
  inventory: (
    <>
      <path d="M21 8V5a1 1 0 0 0-.5-.87l-8-4.6a1 1 0 0 0-1 0l-8 4.6A1 1 0 0 0 3 5v14a1 1 0 0 0 .5.87l8 4.6a1 1 0 0 0 1 0l8-4.6" />
      <path d="M3.3 4.9 12 10l8.7-5.1M12 22V10" />
    </>
  ),
  percent: (
    <>
